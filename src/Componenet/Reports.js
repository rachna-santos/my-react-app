...
export default function Reports() {
    ...
    const { GetAccommodation, accommodation, Reportingdata, reporting, setreporting } = context
    ...
    useEffect(() => {
        const savedData = sessionStorage.getItem("reportingData");
        if (savedData) {
          setreporting(JSON.parse(savedData));
    ...
    useEffect(() => {
        ...
        if (reporting && reporting.length > 0) {
            setTimeout(() => {
                $(tableId).DataTable({
                    // Optional: to preserve header
                    retrieve: true
                });
            }, 100); // delay ensures full render
        }
    }, [reporting]);
                ...
                <div className="container-fluid">  
                    ...
                    <div className="card shadow mb-4">
                            <div className="card-header py-3">
                                <h6 className="m-0 font-weight-bold text-primary">TotalBooking</h6>
                            </div>
